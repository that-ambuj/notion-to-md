      ...
      case "image":
        {
          ...
          if (image_type === "external")
            return md.image(image_caption_plain, blockContent.external.url, this.staticFileDir);
          if (image_type === "file")
            return md.image(image_caption_plain, blockContent.file.url, this.staticFileDir);
        }
        break;
